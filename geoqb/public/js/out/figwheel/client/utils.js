...
return (new CustomEvent(event_name,(function (){var obj39253 = {"detail":data};
return obj39253;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__25420__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__25420__auto__)){
var and__25420__auto____$1 = (window["CustomEvent"]);
...
var args39258 = [];
var len__26545__auto___39264 = arguments.length;
var i__26546__auto___39265 = (0);
while(true){
if((i__26546__auto___39265 < len__26545__auto___39264)){
args39258.push((arguments[i__26546__auto___39265]));

var G__39266 = (i__26546__auto___39265 + (1));
i__26546__auto___39265 = G__39266;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args39258.length)].join('')));
...
var f = (function (){var pred__39261 = cljs.core._EQ_;
var expr__39262 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__39261.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__39262))){
return ((function (pred__39261,expr__39262){
return (function (p1__39254_SHARP_){
return console.warn(p1__39254_SHARP_);
});
;})(pred__39261,expr__39262))
} else {
if(cljs.core.truth_(pred__39261.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__39262))){
return ((function (pred__39261,expr__39262){
return (function (p1__39255_SHARP_){
return console.debug(p1__39255_SHARP_);
});
;})(pred__39261,expr__39262))
} else {
if(cljs.core.truth_(pred__39261.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__39262))){
return ((function (pred__39261,expr__39262){
return (function (p1__39256_SHARP_){
return console.error(p1__39256_SHARP_);
});
;})(pred__39261,expr__39262))
} else {
return ((function (pred__39261,expr__39262){
return (function (p1__39257_SHARP_){
return console.log(p1__39257_SHARP_);
});
;})(pred__39261,expr__39262))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__39268){
var map__39271 = p__39268;
...
var opts = map__39271__$1;
var eval_fn = cljs.core.get.call(null,map__39271__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__39273_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__39275,(0),null);
var v = cljs.core.nth.call(null,vec__39275,(1),null);
...
var args39278 = [];
var len__26545__auto___39281 = arguments.length;
var i__26546__auto___39282 = (0);
while(true){
if((i__26546__auto___39282 < len__26545__auto___39281)){
args39278.push((arguments[i__26546__auto___39282]));

var G__39283 = (i__26546__auto___39282 + (1));
i__26546__auto___39282 = G__39283;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args39278.length)].join('')));
...
if(cljs.core.truth_((function (){var and__25420__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1502108334861