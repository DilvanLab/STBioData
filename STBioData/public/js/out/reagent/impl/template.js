...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7641__auto__,writer__7642__auto__,opt__7643__auto__){
return cljs.core._write.call(null,writer__7642__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__14805 = o;
(G__14805[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__7018__auto__ = !((jsprops == null));
if(and__7018__auto__){
var and__7018__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__14814 = jsprops;
(G__14814["defaultValue"] = value);

(G__14814["onChange"] = ((function (G__14814,v,value,on_change){
return (function (p1__14811_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__14811_SHARP_);
});})(G__14814,v,value,on_change))
);

(G__14814["ref"] = ((function (G__14814,v,value,on_change){
return (function (p1__14812_SHARP_){
return (this$["cljsInputElement"] = p1__14812_SHARP_);
});})(G__14814,v,value,on_change))
);
...
var vec__14821 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__14821,(0),null);
var id = cljs.core.nth.call(null,vec__14821,(1),null);
var class$ = cljs.core.nth.call(null,vec__14821,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___14826 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___14826 == null)){
} else {
var key_14827 = temp__4661__auto___14826;
(jsprops["key"] = key_14827);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__14829 = (new reagent.impl.template.NativeWrapper());
(G__14829["name"] = c);
...
var len__8143__auto___14835 = arguments.length;
var i__8144__auto___14836 = (0);
while(true){
if((i__8144__auto___14836 < len__8143__auto___14835)){
args__8150__auto__.push((arguments[i__8144__auto___14836]));

var G__14837 = (i__8144__auto___14836 + (1));
i__8144__auto___14836 = G__14837;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8151__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq14833){
var G__14834 = cljs.core.first.call(null,seq14833);
var seq14833__$1 = cljs.core.next.call(null,seq14833);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__14834,seq14833__$1);
});
...
break;
default:
var G__14841 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__14841;
continue;
...
var n__7953__auto___14844 = a.length;
var i_14845 = (0);
while(true){
if((i_14845 < n__7953__auto___14844)){
(a[i_14845] = reagent.impl.template.as_element.call(null,(a[i_14845])));
...
var a = cljs.core.into_array.call(null,s);
var n__7953__auto___14847 = a.length;
var i_14848 = (0);
while(true){
if((i_14848 < n__7953__auto___14847)){
var val_14849 = (a[i_14848]);
if((cljs.core.vector_QMARK_.call(null,val_14849)) && ((reagent.impl.template.key_from_vec.call(null,val_14849) == null))){
(o["no-key"] = true);
} else {
}

(a[i_14848] = reagent.impl.template.as_element.call(null,val_14849));

var G__14850 = (i_14848 + (1));
i_14848 = G__14850;
continue;
} else {
}
...
var ctx = ({});
var vec__14854 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__14854,(0),null);
var derefed = cljs.core.nth.call(null,vec__14854,(1),null);
...
var G__14858 = (cljs.core.count.call(null,argv) - first_child);
switch (G__14858) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__14858){
